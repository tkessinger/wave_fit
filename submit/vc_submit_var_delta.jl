...
pars = ["sigma", "K", "mu1", "mu2", "s", "delta", "UL", "num_crossings"]
parvals = Any[sigmalist, Klist, mu1list, mu2list, slist, deltalist, UL_list, num_crossings_list]
parsets = collect(Base.product(parvals...))

nsets = length(parsets)

basename = "var_sigma_delta"
